                            ...
                            <div class="row p-t-20">
                                <div class="col-md-6">
                                    <div class="form-group {{ $errors->has('product_name') ? ' has-error has-danger' : '' }}">
                                        ...
                                        <input type="text" id="product_name" name="product_name" class="form-control" placeholder="Name of the product" value="{{ old('product_name') }}"   autofocus>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group {{ $errors->has('product_price') ? ' has-error has-danger' : '' }}">
                                        ...
                                        <div class="input-group">
                                            <input type="number" id="product_price" name="product_price" class="form-control" placeholder="The price of the product" value="{{ old('product_price') }}"  required>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group {{ $errors->has('product_qty') ? ' has-error has-danger' : '' }}">
                                        ...
                                        <input type="number" id="product_qty" name="product_qty" class="form-control" placeholder="Number of products available" value="{{ old('product_qty') }}"  required>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group {{ $errors->has('product_description') ? ' has-error has-danger' : '' }}">
                                        ...
                                        <textarea name="product_description" id="product_description" cols="30" rows="5" class="form-control" required>{{ old('product_description') }}</textarea>
