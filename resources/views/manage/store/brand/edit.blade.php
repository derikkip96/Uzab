        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    {!! Form::model($brand, [
                        'method' => 'PATCH',
                        'route' => ['merchant.brands.update', $brand->id],
                        'class' => '',
                     ]) !!}
                    ...
                    <div class="form-group {{ $errors->has('brand_name') ? ' has-error has-danger' : '' }}">
                        ...
                        <input name="brand_name" id="brand_name" class="form-control" placeholder="Brand name" value="{{$brand->name}}" required>
                    ...
                    <div class="form-group {{ $errors->has('brand_description') ? ' has-error has-danger' : '' }}">
                        ...
                        <textarea name="brand_description" id="brand_description" cols="30" rows="5" class="form-control" required>{{$brand->decription}}</textarea>
