<div class="uk-card uk-card-default uk-card-hover uk-card-body uk-text-center">
    ...
    <h5><a class="uk-link-heading" href="#">{{ $category->name }}</a></h5>
    <a class="uk-button-default uk-button-small uk-border-rounded" href="{{route('product.category',$category->id)}}">View products</a>
</div>